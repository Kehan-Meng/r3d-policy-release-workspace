...
class AffordanceGuidedCompactorTransformer(nn.Module):
    ...
    def forward(
        self, patch_tokens, pc_pe, heatmap=None, heatmap_mode=None,
    ):
        """
        Args:
        ...
        patch_tokens, pc_pe, heatmap = self._drop_cls_token_if_needed(
            patch_tokens,
            pc_pe,
            heatmap,
        )
        ...
        return compact_tokens, compact_pc_pe
