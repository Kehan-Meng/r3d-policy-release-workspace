...
class AdroitEnv:
    ...
    def __init__(self, env_name, test_image=False, cam_list=None,
                 ...
                 use_point_cloud=False, render_device_id=0):
        ...
        if env_feature_type == 'state':
            ...
            env = BasicAdroitEnv(env, cameras=cam_list,
                                 ...
                                 device=device, render_device_id=render_device_id
                                 )
            ...
            env = BasicAdroitEnv(env, cameras=cam_list,
                                 ...
                                 num_frames=num_frames, device=device, render_device_id=render_device_id)
        else:
    ...
    def reset(self, seed=None):
        ...
        obs_pixels, obs_sensor = self._env.reset(seed=seed)
