...
class BasicAdroitEnv(gym.Env): # , ABC
    ...
    height=84, width=84, test_image=False, num_repeats=1, num_frames=1, encoder_type=None,
    device=None, render_device_id=0):
        self._env = env
        self.env_id = env.env.unwrapped.spec.id
        self.device = device
        self.render_device_id = int(render_device_id)
        ...
        self.env_kwargs = {'cameras' : cameras, 'latent_dim' : latent_dim, 'hybrid_state': hybrid_state,
                           ...
                           'render_device_id': self.render_device_id}
