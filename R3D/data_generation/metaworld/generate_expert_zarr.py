...
R3D_ROOT = Path(__file__).resolve().parents[2]
...
def main(args):
	...
	e = MetaWorldEnv(env_name, device="cuda:0", use_point_crop=True, num_points=args.num_points)
...
if __name__ == "__main__":
	...
	parser.add_argument('--root_dir', type=str, default="../../R3D/data/" )
